          ...
          >
            <div class="ps-lg-1">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <a
                  href="{{ asset('admin/https://www.bootstrapdash.com/product/majestic-admin-pro/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo')}}"
                  target="_blank"
            ...
            <div class="d-flex align-items-center justify-content-between">
              <a
                href="{{ asset('admin/https://www.bootstrapdash.com/product/majestic-admin-pro/')}}"
          ...
          <footer class="footer">
            ...
            >
              <span
                ...
                >Copyright ©
                <a href="{{ asset('admin/https://www.bootstrapdash.com/" target="_blank')}}"
                  >bootstrapdash.com </a
                >2021</span
              >
              <span
