    ...
    <div class="container-scroller">
          ...
          >
            <div class="ps-lg-1">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <a
                  href="{{ asset('dashboard/https://www.bootstrapdash.com/product/majestic-admin-pro/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo')}}"
                  target="_blank"
            ...
            <div class="d-flex align-items-center justify-content-between">
              <a
                href="{{ asset('dashboard/https://www.bootstrapdash.com/product/majestic-admin-pro/')}}"
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex justify-content-center">
          ...
          >
            ...
            /></a>
            <a class="navbar-brand brand-logo-mini" href="{{ asset('dashboard/index.html')}}"
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="{{ asset('dashboard/index.html')}}">
                <i class="mdi mdi-home menu-icon"></i>
                <span class="menu-title">Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('catPage/')}}">
                <i class="mdi mdi-home menu-icon"></i>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('dashboard/pages/forms/basic_elements.html')}}"
                      >Main Category</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('dashboard/pages/ui-features/typography.html')}}"
                      >Sub Category</a
                    >
                  </li>
                </ul>
                    ...
                    <ul class="nav nav-tabs px-4" role="tablist">
                      ...
                      <li class="nav-item">
                        <a
                          ...
                          id="purchases-tab"
                          data-bs-toggle="tab"
                          href="{{ asset('dashboard/#purchases')}}"
                          role="tab"
          ...
          <footer class="footer">
            ...
            >
              <span
                ...
                >Copyright ©
                <a href="{{ asset('dashboard/https://www.bootstrapdash.com/" target="_blank')}}"
                  >bootstrapdash.com </a
                >2021</span
              >
              <span
